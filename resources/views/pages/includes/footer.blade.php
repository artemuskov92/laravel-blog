<div id="footer">
  <div class="footer-instagram-section">
      ...
      <div id="footer-instagram" class="owl-carousel">
          ...
          <div class="item">
              <a href="#"><img src="{{asset('pages/assets')}}/images/ins-1.jpg" alt=""></a>
          </div>
          <div class="item">
              <a href="#"><img src="{{asset('pages/assets')}}/images/ins-2.jpg" alt=""></a>
          </div>
          <div class="item">
              <a href="#"><img src="{{asset('pages/assets')}}/images/ins-3.jpg" alt=""></a>
          </div>
          <div class="item">
              <a href="#"><img src="{{asset('pages/assets')}}/images/ins-4.jpg" alt=""></a>
          </div>
          <div class="item">
              <a href="#"><img src="{{asset('pages/assets')}}/images/ins-5.jpg" alt=""></a>
          </div>
          <div class="item">
              <a href="#"><img src="{{asset('pages/assets')}}/images/ins-6.jpg" alt=""></a>
          </div>
          <div class="item">
              <a href="#"><img src="{{asset('pages/assets')}}/images/ins-7.jpg" alt=""></a>
          </div>
          <div class="item">
              <a href="#"><img src="{{asset('pages/assets')}}/images/ins-8.jpg" alt=""></a>
          </div>
      ...
      <div class="row">
          <div class="col-md-4">
              <aside class="footer-widget">
                  <div class="about-img"><img src="{{asset('pages/assets')}}/images/footer-logo.png" alt=""></div>
